...
public class UserController extends BaseController{
	...
	public ResponseEntity<Map<String,Object>> forgetPassword(@RequestParam String mapstr) throws JsonParseException, JsonMappingException, IOException {
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
	...
	public ResponseEntity<Map<String,Object>> regist(@RequestParam String mapstr) throws JsonParseException, JsonMappingException, IOException {
//		AccountBean acc = objectMapper.readValue(json, AccountBean.class);
		...
		return new ResponseEntity<Map<String,Object>>(userService.regist(user), HttpStatus.OK);
	}
	...
	public ResponseEntity<Map<String,Object>> recommend(@RequestParam String mapstr) throws JsonParseException, JsonMappingException, IOException {
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
	...
	public ResponseEntity<Map<String,Object>> searchNick(@RequestParam String mapstr) throws JsonParseException, JsonMappingException, IOException {
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
	...
	public ResponseEntity<Map<String,Object>> userMessage(@PathVariable String client_id) {
		return new ResponseEntity<Map<String,Object>>(userService.userMessage(client_id), HttpStatus.OK);
	}
	...
	public ResponseEntity<Map<String,Object>> update(HttpServletRequest request,@RequestParam String mapstr,@PathVariable String client_id) throws JsonParseException, JsonMappingException, IOException {
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
		RequestUtil.UserImageReceiver(request, client_id, (CommonsMultipartFile)map.get("image"));
	...
	public ResponseEntity<Map<String,Object>> updatePassword(@RequestParam String mapstr,@PathVariable String client_id) throws JsonParseException, JsonMappingException, IOException {		
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
	...
	public ResponseEntity<Map<String,Object>> userTopic(@RequestParam String mapstr) throws JsonParseException, JsonMappingException, IOException {
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
