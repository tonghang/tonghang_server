...
public class FriendService {
	 ...
	 */
	public void addFriend(String my_id,String friend_id){
		if(!friendDao.isFriend(my_id, friend_id)){
			User my = userDao.findUserById(my_id);
	...
	public Map<String,Object> getInvitationList(String client_id){
		...
		while(it.hasNext()){
			...
			invitmsg.put("invitor", userUtil.userToMapConvertor(invitation.getInviter(),false).get("user"));
