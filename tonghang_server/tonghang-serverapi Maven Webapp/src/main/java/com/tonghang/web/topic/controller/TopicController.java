...
public class TopicController extends BaseController{
	...
	public ResponseEntity<Map<String,Object>> recommendTopic(@RequestParam String mapstr/* String client_id,@RequestParam String etag*/) throws JsonParseException, JsonMappingException, IOException{
		Map map = new ObjectMapper().readValue(mapstr, HashMap.class);
		User user = new User();
